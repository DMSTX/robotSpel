...
public class GameEngine {
    ...
    Stack<Integer> stackX = new Stack<>();          //stack för x-position
    Stack<Integer> stackY = new Stack<>();          //stack för zebrornas y-position
    Stack<Integer> chStackY = new Stack<>();        //stack för gepardernas y-position
    ...
    public int startY() {                           //ger geparder ett slumpmässigt y-värde för sin startposition
        Random rand = new Random();
        int startY = rand.nextInt(8) + 1;
        return startY;
    }

    //nu kommer alla stack-metoder
    ...
    public int createChStartX() {           // tar ut det översta värdet i x-stacken och sparar det
        int chSX = (stackX.pop());
        return chSX;
    }

    public int reserveChStartX(int chSX) {  //adderar eller subtraherar till värdet och lägger tillbaka det i stacken
